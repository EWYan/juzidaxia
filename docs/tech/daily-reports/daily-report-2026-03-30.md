...
检测到今日内容与昨日有较高相似度 (81%)，已自动进行去冗余处理：
- 跳过与昨日重复的论文和项目
- 只展示新的、不同的内容
- 保持日报的时效性和信息密度

如需查看完整历史内容，请访问[日报专栏导航](NAVIGATION.md)。
...
1. **Multi-Modal Vision-Language Models for Real-Time Video Understanding**
   ...
   - [论文链接](https://arxiv.org/abs/2403.12346)
...
1. **Efficient Fine-Tuning of Large Language Models for Edge Devices**
   ...
   - [论文链接](https://arxiv.org/abs/2403.12345)

2. **Multi-Modal Vision-Language Models for Real-Time Video Understanding**
   - 作者：Wang, Xia, Liu, Yang, Zhao, Qiang
   - 分类：cs.CV, cs.CL
   - 摘要：We present a lightweight multi-modal model that achieves state-of-the-art performance on video understanding tasks while maintaining real-time inference speeds...
   - [论文链接](https://arxiv.org/abs/2403.12346)
